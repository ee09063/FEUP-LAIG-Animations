...
void TPinterface::initGUI()
{
	...
	addColumn();
	GLUI_Panel* flag = addPanel("Flag",1);
	//GLUI_EditText* wind = addEditTextToPanel(flag, "Wind", &(((TPscene*) scene)->shaderWind),4);
	GLUI_Spinner* wind = addSpinnerToPanel(flag, "Wind", GLUI_SPINNER_INT, &(((TPscene*) scene)->shaderWind),4);
	wind->set_int_val(10);
}
